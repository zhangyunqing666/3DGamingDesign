...
public class UFOFactory : MonoBehaviour {
	...
	public void Genufo()
	{
		...
		if(free_ufos.Count == 0)
		{
			...
			ufo = Instantiate<GameObject>(Resources.Load<GameObject>("Prefabs/UFO"), v, Quaternion.identity);
		}
		else
		{
			ufo = free_ufos[0];
		...
		ufo.gameObject.GetComponent<Rigidbody> ().isKinematic = false; 
	...
	public void Recycleufo(GameObject usedUFO)
	{
		...
		usedUFO.gameObject.GetComponent<Rigidbody> ().isKinematic = true; 
